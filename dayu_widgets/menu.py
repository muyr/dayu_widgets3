...
class ScrollableMenuBase(QtWidgets.QMenu):
    ...
    def resizeEvent(self, event):
        ...
        style = self.style()
        pm_menu_panel_width = QtWidgets.QStyle.PixelMetric.PM_MenuPanelWidth
        pm_menu_v_margin = QtWidgets.QStyle.PixelMetric.PM_MenuVMargin
        fw = style.pixelMetric(pm_menu_panel_width, None, self)
        h_margin = style.pixelMetric(pm_menu_v_margin, None, self)
